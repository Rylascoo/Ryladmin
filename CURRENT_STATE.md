...
`Rylascoo/Ensemble-Project` was last reconciled at `main@84d0450c5f42f0340c58cdd89eee33daccc6c9e4`. Director build-ahead authority is active: Q-PROD-01 is ACTIVE for provisional real-product construction while E0-D/E/F/G are deferred validation obligations. P03 Slot 1 `E0D-Q01-P03-FULL-20260914-05` remains authorized/unconsumed with provider traffic zero, but it is on Director deferred-test hold and must **not** auto-launch at the prior fixed window; if that window lapses, preserve the namespace and require a later explicit resume/timing amendment. P03 Slot 2 remains unauthorized. PR #165 corrected the stale cross-project Design queue: Q-DESIGN-19 is DONE and Q-DESIGN-20 is **BLOCKED — WAITING FOR STABLE NATIVE EVIDENCE**. Exact-head Validation #917 and push-triggered exact-main Validation #918 passed. Q-ADMIN-03 remains terminally failed closed; native subagents remain default-off and MA-02+ remain blocked.
...
`Rylascoo/Ensemble-Website` was last reconciled read-only at `main@538fa349e046041e2759748d54fda176ac6a9749` after PR #101 / Design Ledger L-196 preserved the Director Bellweather cross-surface boundary. Website Placeholder V2.2 remains live/verified and production bytes remain unchanged. Bellweather remains website-focused and no app placement is authorized; if a future app-specific Bellweather study is explicitly opened, only the app Home/entry surface is eligible, while Productions, Stage, Settings, global chrome and functional task/empty-state surfaces remain excluded. The Website production gate remains held pending a separate consequential Director decision. APPUI Design authority remains on `design/appui01-working-compositions-2026-09-14@0225f9527420d41b2c04a3bc50a30ecf2130d3c9`; static APPUI/native handoff is complete and Design re-entry remains event-driven through Q-DESIGN-20 only after a stable Engineering checkpoint plus native ARM64 review evidence.
...
At recovery, preserve deferred E0 namespaces and consumed evidence exactly; do not perform P03 provider traffic or launch merely because the former window opens. Administrator involvement in Engineering is bounded continuity/race protection, not continuous supervision. Q-PROD-01 belongs to Engineering Sol. APPUI Design re-entry is blocked until Q-DESIGN-20's stable native-evidence trigger exists; do not repeatedly poll moving Engineering source. Website Sol has completed the non-production Bellweather interaction/accessibility study; production remains held, and L-196 additionally limits any separately opened future app Bellweather study to Home/entry only. The Administrator should reconcile stale coordination state or dispatch bounded work, not create a parallel backlog or substitute for an owning Sol.
...
At last reconciliation Project `main@84d0450c5f42f0340c58cdd89eee33daccc6c9e4` has product build-ahead active and PR #165's queue reconciliation integrated with exact-head Validation #917 and exact-main Validation #918 green. Q-PROD-01 is Engineering-owned and active; do not continuously supervise or mutate its working copy. E0-D remains deferred; P03 Slot 1 is authorized/unconsumed on Director hold and must not auto-launch at the former fixed window. P03 Slot 2 remains unauthorized. Website `main@538fa349e046041e2759748d54fda176ac6a9749` carries the current Website/Bellweather boundary: PR #101 / L-196 preserves website-focused Bellweather, holds production, and makes Home/entry the only eligible app surface for any separately opened future study. APPUI authority remains on `design/appui01-working-compositions-2026-09-14@0225f9527420d41b2c04a3bc50a30ecf2130d3c9` with Q-DESIGN-20 blocked on stable native evidence.
