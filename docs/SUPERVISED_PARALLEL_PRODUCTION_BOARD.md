...
- Active Design serial: `design/perf-s1-f2-incumbent-stage-comparison-2026-09-12@fac7ae29a0540cc6a3697ee7898795d9cfaca903`, clean. TECH-01/02/03 are technical construction failures with no subjective Stage result. Method 04 is frozen and changes only source-header construction completeness to the full 80x12 raster envelope; hosted validation is required before challenger construction.
...
| --- | --- | --- | --- | --- | --- |
| PP-ENG-01 | INTEGRATED / LIVE-ACTIVATION PREP NEXT | Engineering Sol / Codex | prepare exact live-run activation | Project `main@8901ea8...`; executable authority `d1073fe2...`; tag `validation/e0b-mixed-cast-implementation-native-arm64` | Integration closeout is on `main`; Q-E0B-01 remains ACTIVE. Exact next is a durable live-run activation binding fresh RunId/root, rubric, provider/model/pricing/data-use facts, credential readiness, and authenticated dual-route quota/capacity. Provider traffic remains blocked until that activation exists. |
...
| PP-DES-01 | ACTIVE / METHOD-04 FROZEN | Design Sol / Codex | bounded recovery preregistration | `design/perf-s1-f2-incumbent-stage-comparison-2026-09-12@fac7ae29...` | TECH-01/02/03 are durable technical construction failures with no subjective Stage result. Method 04 is frozen; exact next is hosted validation before any Method-04 challenger construction. No F2b/design retune or excluded-variable change. |
| PP-DES-CLAUDE-01 | HOLD - METHOD-04 HOSTED VALIDATION | Director-triggered Claude manual review | read-only protocol audit | exact Design serial `fac7ae29...` | Method 04 is committed but its owning authority still requires hosted validation before challenger construction. Wait for that validation result, then build a fresh exact-ref packet only if the boundary remains current. |
