...
`Rylascoo/Ryladmin` is the durable continuity repository for Ryla's Ensemble/Kymaean Project Administrator.

## Authority boundary

Ryladmin owns only Administrator role continuity, commissioning history, runtime provenance pointers, and fresh-chat recovery instructions. It is **not** product, Engineering, Design, provider, validation, experiment, ODR, or queue authority.

For Ensemble work, live authority remains in the owning repositories and connected project sources. A Ryladmin snapshot never overrides a newer authoritative source.
